  ...
  (function(module, exports$1) {
    (function(global, factory) {
      ...
      pp$82.isUsingKeyword = function(isAwaitUsing, isFor) {
        ...
        if (keywordRelationalOperator2.test(id) || isFor && id === "of") {
          return false;
        }
        return true;
      };
      ...
      pp$82.parseStatement = function(context, topLevel, exports$13) {
        ...
        switch (starttype) {
          ...
          case types$12._import:
            ...
            return starttype === types$12._import ? this.parseImport(node) : this.parseExport(node, exports$13);
      ...
      pp$82.parseExportAllDeclaration = function(node, exports$13) {
      ...
      pp$82.parseExport = function(node, exports$13) {
        this.next();
      ...
      pp$82.checkExport = function(exports$13, name, pos) {
        if (!exports$13) {
          return;
        }
        ...
        if (hasOwn2(exports$13, name)) {
          this.raiseRecoverable(pos, "Duplicate export '" + name + "'");
        }
        exports$13[name] = true;
      };
      pp$82.checkPatternExport = function(exports$13, pat) {
        var type = pat.type;
        if (type === "Identifier") {
      ...
      pp$82.checkVariableExport = function(exports$13, decls) {
        if (!exports$13) {
          return;
        }
      ...
      pp$82.parseExportSpecifier = function(exports$13) {
        var node = this.startNode();
      ...
      pp$82.parseExportSpecifiers = function(exports$13) {
      ...
      exports$12.Node = Node3;
      exports$12.Parser = Parser3;
      exports$12.Position = Position3;
      exports$12.SourceLocation = SourceLocation3;
      exports$12.TokContext = TokContext3;
      exports$12.Token = Token3;
      exports$12.TokenType = TokenType3;
      exports$12.defaultOptions = defaultOptions2;
      exports$12.getLineInfo = getLineInfo2;
      exports$12.isIdentifierChar = isIdentifierChar2;
      exports$12.isIdentifierStart = isIdentifierStart2;
      exports$12.isNewLine = isNewLine2;
      exports$12.keywordTypes = keywords2;
      exports$12.lineBreak = lineBreak2;
      exports$12.lineBreakG = lineBreakG2;
      exports$12.nonASCIIwhitespace = nonASCIIwhitespace2;
      exports$12.parse = parse3;
      exports$12.parseExpressionAt = parseExpressionAt2;
      exports$12.tokContexts = types2;
      exports$12.tokTypes = types$12;
      exports$12.tokenizer = tokenizer2;
