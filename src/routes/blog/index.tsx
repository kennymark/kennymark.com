    ...
    <main className="space-y-20">
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-lg text-[color:var(--muted)]">
          Things I've learned shipping software, cross-posted from dev.to.
          Occasionally opinionated, always trying to be useful.
        </p>
      </section>
        ...
        >
          ...
          <div className="hidden rounded-2xl bg-[color:var(--surface-2)] md:flex">
            <div className="flex h-full w-full flex-col justify-between p-6">
              ...
              <p className="font-display text-7xl leading-none text-[color:var(--accent)]">
                “
              </p>
            </div>
          </div>
