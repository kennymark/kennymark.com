...
function Dashboard({ tracks }: DashboardProps) {
  ...
  return (
    <Container maxW="8xl">
      <SEO
        title="Dashboard"
        description="Keep in touch with my personal stats"
      />
      ...
      <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={10}>
        ...
        <chakra.div p={{ base: 4, lg: 8 }} rounded="lg">
          ...
          <Text my={8}>
            Here are some of the songs I listen to the most from Tidal. Tracks
            are being pulled by reverse engineering the Tidal API which isn't
            public yet.
          </Text>
