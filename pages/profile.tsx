    ...
    <>
      ...
      <Container maxW='3xl' p={3}>
        ...
        <chakra.div fontSize='lg' lineHeight='tall' color='gray.600'>
          <chakra.p pb={4}>
            I’m Kenny Coffie, currently a Software Engineer for Evergreen Health. I am front-end
            focused developer with full stack experience. With a total of 5 years of experience, 3
            years freelancing, studying and building hobby projects and 2 years commercial I have
            worked on every kind of application be it small, medium or very large enterprise
            application. I love everything UI and UX on the web but I have also worked on developed
            mobile applications, web apps and some backend applications.
          </chakra.p>
