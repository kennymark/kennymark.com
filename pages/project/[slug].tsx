      ...
      <Grid templateColumns='repeat(6, 1fr)' gap={10}>
        <GridItem colSpan={{ base: 6, lg: 4 }}>
            ...
            {project.link && (
              <Tooltip label='Visit Website' aria-label='Visit website tooltip'>
                <Link isExternal href={project.link} mr={3}>
                  <ExternalLinkIcon color='gray.500' _hover={{ color: 'black' }} />
                </Link>
              </Tooltip>
            )}
            <Tooltip label='View Source Code on Github' aria-label='Visit website tooltip'>
              <Link isExternal href={project.source} color='gray.500' _hover={{ color: 'black' }}>
                Source Code
              </Link>
            </Tooltip>
          </chakra.div>

          <MText variants={variants} initial='initial' animate='animate' my={5} textStyle='p'>
          ...
          <MFlex
            ...
            cursor='pointer'>
            <Box as={Img} src={src} rounded='inherit' mx='auto' shadow='md' maxHeight={700} />
          </MFlex>
        </GridItem>
