...
![unsplash](/images/google-fonts.jpg)

After downloading the font. Follow the steps below

- Create an assets folders in the root of your project with command `mkdir assets`. 
...
- Once that is done, just run `react-native link` from the root of the project.
